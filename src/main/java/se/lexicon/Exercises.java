...
public class Exercises {
    ...
    */
    ...
    public static void exercise3(String message) {
        ...
        Predicate<Person> bornAfter = person -> person.getBirthDate().isAfter(date);
        List<Person> personBornAfter = storage.findMany(bornAfter);
        personBornAfter.forEach(person -> System.out.println(person));
    ...
    public static void exercise4(String message) {
        System.out.println(message);
        //Write your code here
        Predicate<Person> idOne = person -> person.getId() == 123;
        Person withId = storage.findOne(idOne);
    ...
    public static void exercise5(String message) {
        ...
        //Person withId = storage.findOne(id456);
        String NisseNilsson = storage.findOneAndMapToString(id456, person -> person.getFirstName().equalsIgnoreCase("Nisse") + " " + person.getLastName().equalsIgnoreCase("Nilsson") + " born " + person.getBirthDate());
        System.out.println(NisseNilsson);
